...
if [ ! -e /usr/local/apache2/htdocs/datagateway-dataview/datagateway-dataview-settings.json ]
...
if [ ! -e /usr/local/apache2/htdocs/datagateway-download/datagateway-download-settings.json ]
...
if [ ! -e /usr/local/apache2/htdocs/datagateway-search/datagateway-search-settings.json ]
