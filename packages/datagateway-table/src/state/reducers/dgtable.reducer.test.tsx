import DGTableReducer, { initialState as dgTableInitialState } from './dgtable.reducer';
import { DGTableState, EntityCache, StateType } from '../app.types';
import {
  loadFacilityName,
  loadFeatureSwitches,
  configureStrings,
...
describe('dgtable reducer', () => {
  ...
  //   expect(state.dgcommon.facilityName).toEqual('');
  ...
  //   expect(state.dgcommon.urls.apiUrl).toEqual('');
  ...
  //   state.dgcommon.investigationCache = {
  //     1: {
  //       childEntityCount: 3,
  //       childEntitySize: 2,
  //     },
  ...
  //   };
    ...
    //   };
      ...
      //     expect(state.dgcommon.loading).toBe(false);
