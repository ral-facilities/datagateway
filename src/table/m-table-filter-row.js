...
class MTableFilterRow extends React.Component {
  ...
  renderDateTypeFilter = columnDef => {
    ...
    const onStartDateInputChange = date => {
      this.props.onFilterChanged(columnDef.tableData.id, {
        ...columnDef.tableData.filterValue,
        startDate: date,
      });
    };

    const onEndDateInputChange = date =>
      this.props.onFilterChanged(columnDef.tableData.id, {
        ...columnDef.tableData.filterValue,
        endDate: date,
      });
      ...
      dateInputElement = (
        <div>
          <KeyboardDatePicker
            value={
              columnDef.tableData.filterValue
                ? columnDef.tableData.filterValue.startDate || null
                : null
            }
          ...
          <KeyboardDatePicker
            value={
              columnDef.tableData.filterValue
                ? columnDef.tableData.filterValue.endDate || null
                : null
            }
      ...
      dateInputElement = (
        <div>
          <KeyboardDateTimePicker
            ...
            placeholder="From..."
            inputProps={{ 'aria-label': 'Date time from' }}
            clearable
          />
          <KeyboardDateTimePicker
            value={
            ...
            format="yyyy-MM-dd hh:mm:ss"
            placeholder="To..."
            inputProps={{ 'aria-label': 'Date time to' }}
            clearable
          />
        </div>
      );
